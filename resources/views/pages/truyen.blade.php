...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="row mt-2">
				...
				<div class="col-md-5"><img class="img img-responsive" width="100%" class="card-img-top" src="{{asset('http://localhost/lava8/webdocsach/public/uploads/truyen/'.$noibat->hinhanh)}}" alt="{{$noibat->tentruyen}}"></div>
		...
		<div class="row mt-2">
				...
				<div class="col-md-5"><img class="img img-responsive" width="100%" class="card-img-top" src="{{asset('http://localhost/lava8/webdocsach/public/uploads/truyen/'.$tranh->hinhanh)}}" alt="{{$tranh->tentruyen}}"></div>
